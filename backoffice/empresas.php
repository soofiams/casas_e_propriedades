...
<body class="container-fluid">
  ...
  <div class="row">
      <div class="col-6">
        <h2>Empresas <span class="desc">Listagem de Empresas</span></h2>
        <hr>
        <a href="empresas_novo.php"> Novo</a>
        <hr>
      </div>
          ...
          <tbody>
            <?php foreach ($empresas as $e): ?>
              <tr>
                <td><?= $e["id"] ?></td>
                <td><?= $e["titulo"] ?></td>
                <td><?= substr(strip_tags($e["texto"]), 0, 400) ?>...</td>

                <td>
                  <div class="d-flex gap-3 w-100 h-100 justify-content-center">
                    <a href="empresas_editar.php?id=<?= $e["id"] ?>">Editar</a>
                    <a href="empresas_apagar.php?id=<?= $e["id"] ?>">Excluir</a>
                  </div>
                </td>
              </tr>
            <?php endforeach ?>
