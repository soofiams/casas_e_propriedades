...
if (!empty($_POST["apagar"]) && !empty($_POST["resposta"])) {
    ...
    idu_sql("DELETE FROM projetos_comercializacao WHERE id = $id");
...
<body class="container-fluid">
    ...
    <main class="row">
        <?php if ($projetos_item): ?>
            <p>Tem certeza de que deseja apagar as informações de <strong><?= $projetos_item["nome"] ?></strong>?</p>
            <form method="post">
                <input type="hidden" name="apagar" value="<?= $projetos_item["id"] ?>">
