...
$portefolio = select_sql("SELECT * FROM portefolio ORDER BY posicao ASC");
?>
...
<body class="container-fluid">
    ...
    <main class="container my-5">
        ...
        <div class="row">
            <div class="col-6">
                <h2>Imagens do Cabeçalho do Site <span class="desc">Listagem de todas as imagens</span></h2>
                <hr>
                <a href="portefolio_novo.php">Novo</a>
                <hr>
            </div>
            ...
            <div class="col-12">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach ($portefolio as $p): ?>
                            <?php $imagens = json_decode($p["imagens"]) ?>
                            <tr>
                                <td><?= $p["id"] ?></td>
                                <td><img src="<?= $imagens[0] ?>" alt="" style="max-height:70px"></td>
                                <td><?= $p["nome"] ?></td>
                                <td><?= $p["localidade"] ?></td>
                                <td><?= $p["posicao"] ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="portefolio_editar.php?id=<?= $p["id"] ?>">Editar</a>
                                    <a href="portefolio_apagar.php?id=<?= $p["id"] ?>">Apagar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
