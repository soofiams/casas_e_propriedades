...
if (!empty($_POST["apagar"]) && !empty($_POST["resposta"])) {
    ...
    idu_sql("DELETE FROM empresas WHERE id = $id");
...
<body class="container-fluid">
    ...
    <main class="row">
        <?php if ($empresa): ?>
            <p>Tem certeza de que deseja apagar a empresa <strong><?= $empresa["titulo"] ?></strong>?</p>
            <form method="post">
                <input type="hidden" name="apagar" value="<?= $empresa["id"] ?>">
