...
if (!empty($_POST)) {
    ...
    idu_sql("INSERT INTO portefolio (imagens, nome, localidade, posicao, mostrar) 
         VALUES ('$imagem', '$nome', '$localidade', $posicao, $mostrar)");
...
<body class="container-fluid">
    ...
    <main>
        <div class="row">
            <div class="col-4">
                <br><br>
                <h2>Portefólio <span class="desc">Inserir novo Imóvel.</span></h2>
                <hr>
                <a href="portefolio.php">Fechar</a>

                <form action="" class="caixa form-login" method="post">
                    <label for="imagens">Imagem: *</label>
                    <input type="text" name="imagens" id="imagens" required readonly>
                    ...
                    <input type="text" name="localidade" placeholder="subtitulo" required>
                    <label for="posicao">Posição:</label>
                    <input type="number" name="posicao" value="1" min="1" required>
