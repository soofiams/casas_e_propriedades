...
<body class="container-fluid">
  ...
  <main class="container my-5">
    ...
    <div class="row">
      <div class="col-6">
        <h2>Destaques do Site <span class="desc">Listagem de todos os destaques</span></h2>
        <hr>
      </div>
      <br><br>
      <div class="col-12">
          ...
          <tbody>
            <?php foreach ($imoveis as $i): ?>
              ...
              <tr>
                ...
                <td>
                  <a href="destaques_editar.php?id=<?= $i["id"] ?>">Editar</a>
                  <a href="destaques_apagar.php?id=<?= $i["id"] ?>">Apagar</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
