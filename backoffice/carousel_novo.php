...
if (!empty($_POST)) {
  ...
  idu_sql("INSERT INTO carrossel_header (imagens, titulo, subtitulo, texto, posicao, ativo) 
           VALUES ('$imagem', '$titulo', '$subtitulo', '$texto', $posicao, $ativo)");
...
<body class="container-fluid">
  ...
  <main>
    <div class="row">
      <div class="col-4">
        <br><br>
        <h2>Carrossel <span class="desc">Inserir novo Carrossel.</span></h2>
        <hr>
        <a href="carrossel.php">Fechar</a>
