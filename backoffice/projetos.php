...
$projetos = select_sql("SELECT * FROM projetos_comercializacao ORDER BY id ASC");
?>
...
<body class="container-fluid">
    ...
    <main class="container my-5">
        ...
        <h2>Projetos do Site <span class="desc">Listagem de todas as imagens</span></h2>
        <hr>
        <a href="projetos_novo.php"> Novo </a>
        <hr>
            ...
            <tbody>
                <?php foreach ($projetos as $p): ?>
                    <tr>
                        ...
                        <td>
                            <a href="projetos_editar.php?id=<?= $p["id"] ?>">Editar</a>
                            <a href="projetos_apagar.php?id=<?= $p["id"] ?>">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
