...
$carrossel = select_sql("SELECT * FROM carrossel_header ORDER BY posicao ASC");
?>
  ...
  <main class="container my-5">
    ...
    <div class="row">
      <div class="col-6">
        ...
        <hr>
        <a href="carousel_novo.php"> Novo</a>
        <hr>
      </div>
      <div class="col-12">
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php foreach ($carrossel as $linha): ?>
              <tr>
                <td><?= $linha["id"] ?></td>
                <td><img src="<?= $linha["imagens"] ?>" alt="" style="max-height:50px"></td>
                <td><?= $linha["titulo"] ?></td>
                ...
                <td>
                  <a href="carousel_editar.php?id=<?= $linha["id"] ?>">Editar</a>
                  <a href="carrossel_apagar.php?id=<?= $linha["id"] ?>">Apagar</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
